...
Для использования отличной от "111" парольной фразы необходимо также изменить значение Environment="BORG_PASSPHRASE=***111***" в файле **templates/borg-backup.service**.
...
**borg_restore.txt** - файл процесса восстановления из резервной копии, записанный утилитой script
